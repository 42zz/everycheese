...
def test_good_cheese_list_view_expanded(rf):
  ...
  # collable_obj is analogous to a function-based view
  callable_obj = CheeseListView.as_view()
  # Pass in the request in to the collable_obj to get an HTTP response server up by Django
...
def test_cheese_update(client, user, cheese):
  ...
  # Check that the chees has been changed
